...
3. "create_task": User wants to add, create, or log a new task or to-do item.
4. "add_task": User wants to add a task to their list.
5. "info": User is asking a purely informational query about their state, deadlines, or setup.
