...
export default function LoginPage() {
  ...
  async function submit(event: React.FormEvent) {
    ...
    try {
      ...
      setError("Could not log in with those credentials.");
    }
  }
  ...
  return (
    <main className="mx-auto max-w-md px-4 py-12">
      ...
      <p className="mt-4 text-sm text-slate-600">New here? <Link className="font-medium" href="/signup">Create an account</Link></p>
    </main>
  );
}
