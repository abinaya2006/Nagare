...
import { useNANI } from "@/hooks/useNANI";
...
/**
 * NANI's home: a 420px sliding sidebar (full-width on mobile) containing a
 * gentle chat interface. Messages render as floating thought bubbles.
 */
export default function NANISidebar({ isOpen, onClose }: NANISidebarProps) {
  const { messages, isThinking, error, sendMessage } = useNANI();
